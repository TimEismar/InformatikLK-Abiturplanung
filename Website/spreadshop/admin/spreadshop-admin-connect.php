...
class SpreadshopAdminConnect {
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <p class="description">
                            ...
                            https://shop.spreadshirt.net/<strong>this-name</strong>.
                        </p>
                    </td>
                </tr>
    ...
    private static function renderConnected($platform, $shopId, $locale) {
        ...
        <p>
            ...
            For example, if you want this page to show https://shop.spreadshirt.com/shop-template-brand/cafe+koenji+logo?idea=5d5534fd2051766bd5973b60,<br/>
    ...
    private static function fetchCoreData($shopIdOrName, $platform) {
        ...
        try {
            $response = wp_remote_get('https://shop.spreadshirt.' . $tld . '/' . $shopIdOrName . '/shopData/core?agent=spreadshopWpPluginSignup');
