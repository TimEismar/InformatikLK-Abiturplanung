...
function spreadshopEmbed($pushStateBaseUrl, $startTokenOverride) {
    ...
    $config_array = array(
        'shopName' => get_option('spreadshopID'),
        'prefix' => 'https://shop.spreadshirt.' . $tld,
        'baseId' => 'myShop',
        ...
        'integrationProvider' => 'Spreadshirt Wordpress plugin v1.6.2',
    );
    ...
    $output .= '    </main>';
    $output .= '</div>';
    $output .= '<script src="' . 'https://shop.spreadshirt.' . $tld . '/shopfiles/shopclient/shopclient.nocache.js"></script>';
    return $output;
}
